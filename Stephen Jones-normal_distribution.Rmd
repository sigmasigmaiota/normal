...
1.  Make a histogram of men's heights and a histogram of women's heights.  How 
    ...
    <strong>Height is normally distributed and clustered somewhat. Mean height for males is `r round(mean(mdims$hgt),1)` cm or `r floor(mean(mdims$hgt)*0.0328084)` ft, `r round((mean(mdims$hgt)*0.0328084-floor(mean(mdims$hgt)*0.0328084))*12,0)` in. Mean height for females is `r round(mean(fdims$hgt),1)` cm or `r floor(mean(fdims$hgt)*0.0328084)` ft, `r round((mean(fdims$hgt)*0.0328084-floor(mean(fdims$hgt)*0.0328084))*12,0)` in.
